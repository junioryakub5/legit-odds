...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Welcome to Legit Odds. By accessing or using our website and services, you agree to be
        ...
        <p>
          ...
          all visitors, users, and customers of Legit Odds.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Legit Odds provides premium football prediction tips (&ldquo;Predictions&rdquo;) to registered
    ...
    content: (
      <>
        <p>
          ...
          and displayed to you <strong style={{ color: "#f59e0b" }}>immediately</strong> — no manual
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>Legit Odds does <strong>not</strong> collect, store, or have access to your card details.</li>
    ...
    content: (
      <>
        <p>
          ...
          By using Legit Odds, you confirm that you are at least 18 years of age.
        </p>
        <ul>
    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>Legit Odds is not responsible for any financial losses resulting from acting on our predictions.</li>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          All content on Legit Odds — including prediction slips, analysis, branding, design, and
          text — is the intellectual property of Legit Odds and is protected by applicable copyright laws.
        </p>
        <ul>
